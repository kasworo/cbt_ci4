    ...
    <tbody>
        ...
        <tr height="20px">
            <td align="center" colspan="3"
                style="font-size:11px;font-weight:bold;padding-left:11px;border-bottom: 1px solid black">
                TAHUN
                PELAJARAN
                <?php echo $uji['tahun']; ?></td>
        </tr>
        <tr height="20px">
            <td colspan="4"><br></td>
        </tr>
        ...
        <tr height="20px">
            ...
            <td>:</td>
            <td style="font-size:11px;font-weight:normal;">
                <?php echo ucwords(strtolower($pst['tmplahir'])) . ', ' . $pst['tgllahir']; ?>
            </td>
        </tr>
        <tr height="20px">
